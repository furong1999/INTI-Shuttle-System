  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="busdriver1home.php">Tan Eng Heng</a></h1>
      ...
      <nav class="nav-menu">
        <ul>
          <li><a href="busdriver1home.php"><i class="bx bx-home"></i> <span>Home</span></a></li>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Details</h2>
          <ol>
            <li><a href="busdriver1home.php">Home</a></li>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Destination</strong>: Elit Avenue</li>
            </ul>
          </div>
        ...
        <div class="portfolio-description">
          ...
          <p>
            Inti College Penang - Elit Avenue
            </p>
        </div>
