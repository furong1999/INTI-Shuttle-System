...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="flipcard/style.css">
    ...
    <div class="flip-card">
        <div class="flip-card-inner">
            <div class="flip-card-front">
                <img src="flipcard/avatar.jpg" alt="Avatar" style="width:300px;height:300px;">
            </div>
            <div class="flip-card-back">
                <h1>Mr.Leong</h1>
                <p>Contact No. :0134956775</p>
            </div>
        </div>
    </div>
</div>
